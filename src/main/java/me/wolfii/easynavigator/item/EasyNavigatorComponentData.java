...
public class EasyNavigatorComponentData {
    public static final ComponentType<Boolean> CUSTOM_SCALE = ComponentType.<Boolean>builder().codec(Codec.BOOL).packetCodec(PacketCodecs.BOOL).build();
    public static final ComponentType<Boolean> REMOVE_ENCHANTMENT_GLINT = ComponentType.<Boolean>builder().codec(Codec.BOOL).packetCodec(PacketCodecs.BOOL).build();
